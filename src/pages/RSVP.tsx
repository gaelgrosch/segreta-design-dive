...
const RSVP = () => {
  ...
  return (
    <div className="min-h-screen relative" style={{ backgroundColor: '#718E98', minHeight: '100vh' }}>
      <WeddingHeader />
      
      {/* Continuous Dividing Line */}
      <div className="absolute left-1/2 transform -translate-x-1/2 w-px bg-black hidden lg:block" style={{ top: '88px', bottom: '0px' }}></div>
